...
\hline
Threshold & Avg. nodes (all windows) & Avg. nodes (outside holiday) & Total windows & Holiday windows & Non-holiday windows \\
\hline
0.70 & 2.8006  & 2.6119  & 579 & 28 & 551 \\
0.65 & 5.5141  & 5.1196  & 579 & 28 & 551 \\
0.60 & 11.1939 & 10.4813 & 579 & 28 & 551 \\
\hline
\end{tabular}
\caption{Average number of nodes across all windows and outside holiday windows for different thresholds.}
\label{tab:avg_nodes_thresholds}
\end{table}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{figures/kendall_mean_node_distribution.png}
    \caption{Enter Caption}
    \label{fig:placeholder}
\end{figure}
...
\begin{table}[htbp]
\centering
\caption{Graph density statistics as a function of the Kendall similarity threshold $\tau$, computed over 30-day sliding windows. The table compares the average number of neighbours per product across all temporal windows versus off-peak (non-holiday) periods.}
\label{tab:kendall_threshold_density}
\begin{tabular}{cccccc}
\toprule
\textbf{Threshold} $\tau$ 
    & \textbf{Avg. Nodes (All)} 
    & \textbf{Avg. Nodes (Off-peak)} 
    & \textbf{Total Windows} 
    & \textbf{Peak Windows} 
    & \textbf{Off-peak Windows} \\
\midrule
0.46 & 10.12 & 9.67 & 579 & 28 & 551 \\
0.50 & 5.14 & 4.88 & 579 & 28 & 551 \\
0.54 & 2.74 & 2.61 & 579 & 28 & 551 \\
\bottomrule
\end{tabular}
\end{table}
