...
def build_dynamic_graph(target_id, target_preds, df_wide, cat_labels, date_cols, metric, threshold=None, percentile=None, enable_edges_within_star=True, enable_second_degree=False):
    G = nx.Graph()
