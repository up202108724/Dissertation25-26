...
from graphsageinference import recursive_inference_graphsage_mlp
        ...
        for seed in SEEDS:
            ...
            for config in all_configs:
                ...
                for param_val, window_sz, step_sz, enable_edges, enable_second_degree in iterator:
                    ...
                    model, _, t_losses, v_losses, best_epoch = train_graphsage_mlp(
                    ...
                    forecast = recursive_inference_graphsage_mlp(
                        model=model,
                        scaler=scaler,
