...
from graphsagedataset import make_xy_windows
from lstm import LSTM as LSTMModel
from mlp import MLPForecaster, make_windows, WindowDataset
import pandas as pd
import os
...
def train_pure_sage(
    ...
    if use_graphs:
        ...
        from graphsage_pyg import generate_node_features as _gnf
    ...
    for epoch in range(1, cfg.epochs + 1):
        ...
        for batch in train_loader:
            if use_graphs:
                ...
                pred = model(pyg_batch, target_node_indices, ts_batch)
            else:
                xb, yb = batch
