...
from GNN.DynamicSimilarities.GAT.TimedistributedMLP_GCN.gat_tdmlpdataset import (
    GCNTimeSeriesDataset,
    collate_pyg_ts,
    build_pyg_graphs_from_nx_windows,
)
from GNN.DynamicSimilarities.GAT.TimedistributedMLP_GCN.gat_mlpinference import _recursive_forecast_gcn_perstep

# Local MLP-headed model + training loop + plotting
from GNN.DynamicSimilarities.GAT.TimedistributedMLP_GCN.gat_mlp_model import SimpleGATMLPForecaster
from GNN.DynamicSimilarities.GAT.TimedistributedMLP_GCN.gat_mlp_train import train_model
...
# ── Constants ──────────────────────────────────────────────────────────────
DATA_PATH = os.path.normpath(os.path.join(SCRIPT_DIR, '../../../../dataset/data_andre_fulfilled.feather'))
DATE_COL = 'date'
TARGET_COL = 'value'
...
grid_configs = [
    ...
    {'metric': 'spearman', 'thresholds': [0.82,0.85,0.88]},
]
