...
def main():
    ...
    product_times = []          # (product_id, store_id, seconds)
    total_t0 = time.time()
    ...
    for product_id, store_id in PRODUCTS_TO_TEST:
        ...
        if RUN_LSTM_BASELINE:
            ...
            bl_model_path = os.path.join(
                ...
                f"lstm_baseline_{product_id}_{store_id}.pth",
            )
        ...
        for config in all_configs:
            ...
            for ablate_z, param_val, window_size, step_size, enable_edges, enable_second_degree in iterator:
                ...
                base_name = (
                    ...
                    f"_w{window_size}_s{step_size}_{param_label}{res_tag}"
                )
