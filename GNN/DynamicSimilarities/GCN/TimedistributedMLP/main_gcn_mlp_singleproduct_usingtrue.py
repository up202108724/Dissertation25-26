...
from gcn_mlpinference_usingtrue import _recursive_forecast_gcn_perstep
            ...
            for config in all_configs:
                ...
                for ablate_z, param_val, window_size, step_size, enable_edges, enable_second_degree in iterator:
                    ...
                    base_name = (
                        ...
                        f"_w{window_size}_s{step_size}_{param_label}{res_tag}{az_tag}_seed_{seed}_usingtrue"
                    )
                    ...
                    if LOAD_SAVED_MODEL_FOR_INFERENCE and os.path.exists(combined_pkl_path):
                        ...
                        train_time   = _ckpt.get('train_time', None)
                        ...
                        print(f"Saved combined checkpoint to {combined_pkl_path}")
                    ...
                    forecast = _recursive_forecast_gcn_perstep(
                        ...
                        true_target_scaled=test_scaled,
                        true_target_unscaled=test,
                    )
                ...
                for (w, s), res_dicts in grouped_results.items():
                    ...
                    save_plot_path = os.path.join(
                        sub_dir,
                        f"item_{product_id}_{metric}_seed_{seed}_all_configs_usingtrue.html",
                    )
                    emb_title = (
