...
PRODUCTS_TO_TEST = [(26008, 6269), (907967, 6269), (907969,6269),(911753,6269)]
...
def build_forecaster(variant, ablate_z, in_channels, ts_input_size):
    ...
    if ablate_z:
        if head == 'lstm':
            return AblationLSTMForecaster(
                ...
                lstm_layers=NUM_LAYERS, horizon=1, dropout=DROPOUT_LSTM,
            )
    ...
    if variant == 'gcn_mlp':
        return SimpleGCNMLPForecaster(
            ...
            hidden_sizes=MLP_HIDDEN_SIZES, horizon=1, dropout=DROPOUT_MLP,
        )
    if variant == 'gat_mlp':
