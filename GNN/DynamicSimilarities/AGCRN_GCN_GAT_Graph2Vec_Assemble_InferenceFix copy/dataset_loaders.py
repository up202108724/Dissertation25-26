...
def nx_window_to_pyg(
    ...
    x = torch.from_numpy(window_node_features(window_values, mode=node_feature_mode))
...
# ── dataset ─────────────────────────────────────────────────────────────────
class GCNLSTMTimeSeriesDataset(Dataset):
    """
...
from torch.utils.data import Dataset
from torch_geometric.data import Batch, Data
from node_feature_builder import window_node_features
...
# ── dataset ───────────────────────────────────────────────────────────────
class GCNMLPTimeSeriesDataset(Dataset):
    """
...
class Graph2VecTimeSeriesDataset(Dataset):
...
class Graph2VecMLPWindowDataset(Dataset):
