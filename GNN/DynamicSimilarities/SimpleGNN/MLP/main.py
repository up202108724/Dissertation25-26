...
from GNN.DynamicSimilarities.SimpleGNN.MLP.gnninference import recursive_inference, recursive_inference_no_graph
            ...
            for config in all_configs:
                ...
                for param_val, window_sz, step_sz, enable_edges, enable_second_degree in iterator:
                    ...
                    model, _, t_losses, v_losses, best_epoch = train_mlp_forecaster(
                        ...
                        graphs=graphs_list, test_size=forecast_horizon, gnn_in_channels=window_sz + 8
                    )
