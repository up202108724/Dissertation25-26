...
def recursive_inference_gnn_lstm(
    ...
    """
    Recursive 1-step-ahead inference for the GNN-LSTM model.
    ...
    from gnn_pyg import compute_target_node_features_pure, compute_neighbor_node_features_pure
